...
type LoginServiceClient interface {
	...
	FindMemberById(ctx context.Context, in *UserMessage, opts ...grpc.CallOption) (*MemberMessage, error)
...
func (c *loginServiceClient) FindMemberById(ctx context.Context, in *UserMessage, opts ...grpc.CallOption) (*MemberMessage, error) {
	out := new(MemberMessage)
	err := c.cc.Invoke(ctx, "/login.service.v1.LoginService/FindMemberById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LoginServiceServer interface {
	...
	FindMemberById(context.Context, *UserMessage) (*MemberMessage, error)
...
func (UnimplementedLoginServiceServer) FindMemberById(context.Context, *UserMessage) (*MemberMessage, error) {
...
func _LoginService_FindMemberById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoginServiceServer).FindMemberById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/login.service.v1.LoginService/FindMemberById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).FindMemberById(ctx, req.(*UserMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LoginService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LoginService_FindMemberById_Handler,
		},
		{
