...
type AuthSaveReq struct {
	...
	OrganizationCode string `protobuf:"bytes,1,opt,name=OrganizationCode,proto3" json:"OrganizationCode,omitempty"`
...
func (x *AuthSaveReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthSaveReq) ProtoMessage() {}

func (x *AuthSaveReq) ProtoReflect() protoreflect.Message {
	mi := &file_auth_service_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthSaveReq.ProtoReflect.Descriptor instead.
func (*AuthSaveReq) Descriptor() ([]byte, []int) {
	return file_auth_service_proto_rawDescGZIP(), []int{6}
}

func (x *AuthSaveReq) GetOrganizationCode() string {
	if x != nil {
		return x.OrganizationCode
	}
	return ""
...
func (x *AuthSaveReq) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *AuthSaveReq) GetSort() int32 {
	if x != nil {
		return x.Sort
	}
	return 0
...
func (x *AuthSaveReq) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *AuthSaveReq) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *AuthSaveReq) GetCreateBy() int64 {
	if x != nil {
		return x.CreateBy
	}
	return 0
...
func (x *AuthSaveReq) GetIsDefault() int32 {
	if x != nil {
		return x.IsDefault
	}
	return 0
...
func (x *AuthSaveReq) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x22, 0x59, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x75,
	0x74, 0x68, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x30, 0x0a, 0x04, 0x6c, 0x69, 0x73,
	0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x41, 0x75, 0x74, 0x68, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74,
	0x6f, 0x74, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61,
	0x6c, 0x22, 0xa7, 0x02, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x41, 0x75, 0x74,
	...
	0x52, 0x09, 0x43, 0x61, 0x6e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x22, 0x6a, 0x0a, 0x0d, 0x41,
	0x70, 0x70, 0x6c, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x04,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x75, 0x74,
	...
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x64,
	0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x68, 0x65, 0x63,
	0x6b, 0x65, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x9b, 0x02, 0x0a, 0x12, 0x50, 0x72, 0x6f, 0x6a,
	...
	0x52, 0x06, 0x69, 0x73, 0x41, 0x75, 0x74, 0x68, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x68, 0x65, 0x63,
	0x6b, 0x65, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x63, 0x68, 0x65, 0x63, 0x6b,
	0x65, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6b, 0x65, 0x79, 0x12, 0x3f, 0x0a, 0x08, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e,
	0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x73, 0x65,
	...
	0x6c, 0x64, 0x72, 0x65, 0x6e, 0x22, 0x27, 0x0a, 0x11, 0x41, 0x75, 0x74, 0x68, 0x4e, 0x6f, 0x64,
	0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x69,
	0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xdd,
	0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71, 0x12, 0x2a,
	0x0a, 0x10, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f,
	0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69,
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x54, 0x69,
	...
	0x53, 0x6f, 0x72, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05,
	...
	0x49, 0x73, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x09, 0x49, 0x73, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x54, 0x79,
	0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x54, 0x79, 0x70, 0x65, 0x32, 0xd2,
	...
	,
...
var file_auth_service_proto_goTypes = []interface{}{
	...
	(*ListAuthMessage)(nil),    // 1: auth.service.v1.ListAuthMessage
	(*ProjectAuth)(nil),        // 2: auth.service.v1.ProjectAuth
	(*ApplyResponse)(nil),      // 3: auth.service.v1.ApplyResponse
	(*ProjectNodeMessage)(nil), // 4: auth.service.v1.ProjectNodeMessage
	(*AuthNodesResponse)(nil),  // 5: auth.service.v1.AuthNodesResponse
	(*AuthSaveReq)(nil),        // 6: auth.service.v1.AuthSaveReq
}
var file_auth_service_proto_depIdxs = []int32{
	2, // 0: auth.service.v1.ListAuthMessage.list:type_name -> auth.service.v1.ProjectAuth
	4, // 1: auth.service.v1.ApplyResponse.list:type_name -> auth.service.v1.ProjectNodeMessage
	4, // 2: auth.service.v1.ProjectNodeMessage.children:type_name -> auth.service.v1.ProjectNodeMessage
	...
	6, // 6: auth.service.v1.AuthService.AuthSave:input_type -> auth.service.v1.AuthSaveReq
	1, // 7: auth.service.v1.AuthService.AuthList:output_type -> auth.service.v1.ListAuthMessage
	3, // 8: auth.service.v1.AuthService.Apply:output_type -> auth.service.v1.ApplyResponse
	5, // 9: auth.service.v1.AuthService.AuthNodesByMemberId:output_type -> auth.service.v1.AuthNodesResponse
	2, // 10: auth.service.v1.AuthService.AuthSave:output_type -> auth.service.v1.ProjectAuth
